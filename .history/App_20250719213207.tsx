...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center p-6 sm:p-10 lg:p-16 font-grotesk">
      <Navbar onReset={handleReset} showControls={stage > InterviewStage.WELCOME && stage < InterviewStage.FEEDBACK}/>
      <main className="w-full max-w-7xl mt-12 pt-24">
      ...
      <footer className="w-full max-w-7xl mt-12 text-center text-slate-400 text-base animate-fade-in-up font-grotesk">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 py-10 border-t border-slate-700">
          <div className="flex flex-col items-center md:items-start">
            <span className="text-3xl font-extrabold text-cyan-400 mb-2 tracking-tight font-grotesk">AceMock</span>
            <p className="max-w-xs text-slate-400 mb-2 leading-relaxed">Your AI-powered interview coach for mastering every stage of the tech interview process.</p>

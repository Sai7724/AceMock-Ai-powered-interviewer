...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center p-4 sm:p-6 lg:p-8">
      ...
      <footer className="w-full max-w-7xl mt-8 text-center text-slate-400 text-base animate-fade-in-up">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 py-8 border-t border-slate-700">
          <div className="flex flex-col items-center md:items-start">
            <span className="text-2xl font-bold text-cyan-400 mb-2">AceMock</span>
            <p className="max-w-xs text-slate-400 mb-2">Your AI-powered interview coach for mastering every stage of the tech interview process.</p>

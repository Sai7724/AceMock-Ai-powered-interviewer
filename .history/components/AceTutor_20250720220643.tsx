  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-slate-900 text-slate-100">
      ...
      <aside className="w-full md:w-80 bg-slate-800 p-6 flex-shrink-0 border-r border-slate-700">
        <h2 className="text-xl font-bold mb-4 text-cyan-400">AceTutor Configuration</h2>
      ...
      <main className="flex-1 p-8 flex flex-col items-center">
        <h1 className="text-3xl font-bold text-cyan-400 mb-6">AceTutor - AI Learning Path Generator</h1>

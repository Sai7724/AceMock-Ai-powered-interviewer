...
export default function Navbar({ onReset, showControls }: NavbarProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 font-grotesk">
      <nav className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <div className="flex items-center justify-between h-24">
          <div className="flex items-center space-x-4 cursor-pointer select-none">
            <Logo />
            <span className="text-3xl sm:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-cyan-400 tracking-tight font-grotesk">AceMock</span>
          </div>

      ...
      <div className="w-full max-w-3xl mx-auto mt-32 mb-20 rounded-3xl shadow-2xl bg-slate-800 p-0 sm:p-4 md:p-8">
        ...
        <div className="relative rounded-2xl shadow-xl p-6 md:p-10 mb-10 flex flex-col md:flex-row items-center md:items-end gap-6 md:gap-10 overflow-hidden bg-slate-900">
          ...
          <button
            ...
            className="absolute top-4 right-4 z-20 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white font-bold py-2 px-4 rounded-full shadow-lg shadow-cyan-500/30 transform hover:scale-105 transition-all duration-300 ease-in-out text-sm flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-opacity-50"

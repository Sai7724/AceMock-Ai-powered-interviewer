...
import { InterviewResults, Feedback, AptitudeFeedback, TechnicalQAFeedback } from '../types';
  ...
  return (
    <div className="animate-fade-in">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-slate-100">Interview Complete!</h2>
